...
public class Restaurants extends AppCompatActivity implements TitleFragment.ListSelectionListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("A2, Restaurants");

        // Get resources:
        titleArray = getResources().getStringArray(R.array.restaurant_titles);
        urlArray = getResources().getStringArray(R.array.restaurant_urls);
        ...
        // Re-attach all fragments in case of configuration change:
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.restaurants_option_menu, menu);
        return true;
    }
